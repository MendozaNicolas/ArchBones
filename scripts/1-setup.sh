...
if ! source $HOME/ArchBones/configs/setup.conf; then
    ...
    echo "NAME_OF_MACHINE=${name_of_machine,,}" >>${HOME}/ArchBones/configs/setup.conf
fi
echo -ne "
-------------------------------------------------------------------------
                    Adding User
...
if [ $(whoami) = "root" ]; then
    ...
    cp -R $HOME/ArchBones /home/$USERNAME/
    chown -R $USERNAME: /home/$USERNAME/ArchBones
    echo "ArchBones copied to home directory"
